...
from PyQt5.QtWidgets import (
    ...
    QStatusBar, QFrame, QSizePolicy, QShortcut, QComboBox
)
...
#  Works both during development and when
#  frozen by PyInstaller (--onefile / --onedir)
# \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
def _resource_path(relative: str) -> str:
    """Return absolute path to a bundled resource.

    During normal execution ``__file__`` is used as the base.
    When frozen by PyInstaller the temporary extraction folder
    ``sys._MEIPASS`` is used instead.
    """
    ...
    def line_number_area_paint_event(self, event):
        ...
        while block.isValid() and top <= event.rect().bottom():
            if block.isVisible() and bottom >= event.rect().top():
                painter.setPen(QColor(ACCENT if block_num == current_line else LINE_NUM_FG))
                painter.drawText(
                    0, top,
...
class FindBar(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        for w in [
            QLabel("Find:"), self.find_input, self.prev_btn, self.next_btn,
    ...
    def _search(self, forward=True, from_top=False):
        ...
        self.match_label.setStyleSheet(
            f"color: {RED};" if not count else f"color: {GREEN};"
        )
    ...
    def _replace_all(self):
        ...
        if self.case_cb.isChecked():
            ...
            new_content = self._case_insensitive_replace(content, needle, replacement)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # \u2500\u2500 App icon (works in dev and when frozen by PyInstaller) \u2500\u2500
    ...
    def _setup_menu(self):
        ...
        self._add_action(help_menu, "About NordEditor", self._show_about)
    ...
    def new_tab(self, filepath=None):
        ...
        # Defer setFocus so Wayland doesn't emit requestActivate warnings
    ...
    def save_file_as(self):
        ...
        if path:
            ...
            self._lang_label.setText(f"  {editor._language}  ")
    ...
    def _show_about(self):
        dlg = QDialog(self)
        dlg.setWindowTitle("About NordEditor")
        ...
        # App name
        title = QLabel("NordEditor")
        title.setObjectName("title")
        title.setAlignment(Qt.AlignCenter)
        layout.addWidget(title)

        # Tagline
        subtitle = QLabel("A clean, dark-themed code editor built with PyQt5")
...
def main():
    ...
    # Set app-level icon (taskbar, dock, Alt+Tab switcher)
    icon_path = _resource_path(os.path.join("assets", "icon.png"))
    if os.path.exists(icon_path):
